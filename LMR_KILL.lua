...
if (table.find(BlacklistedNames, game:GetService("Players").LocalPlayer.Name:lower()) or table.find(BlacklistedIds, game:GetService("Players").LocalPlayer.UserId)) then
    game:GetService("ReplicatedStorage"):WaitForChild("rEvents"):WaitForChild("rebirthRemote"):InvokeServer("rebirthRequest")
    game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer("Eu tentei usar um dos scripts do Sad_OZ 😭", "All")
end
]])()
...
titleButton.Text = "LMR AUTO KILL ON TOP"
titleButton.TextColor3 = Color3.fromRGB(120,100%,50%)
